package com.zhangwei.test.mongodb;
/*
 * JavaWordCount.java
...
public class MongoJavaWordCount {
    
    public static void main(String[] args) {
        //spark://test-push-centerserver:7077
    	//local
        JavaSparkContext sc = new JavaSparkContext("spark://test-push-centerserver:7077", "Java Word Count");
        
        Configuration config = new Configuration();
        config.set("mongo.input.uri", "mongodb://172.16.10.71:27017/sparkdb.input");
        config.set("mongo.output.uri", "mongodb://172.16.10.71:27017/sparkdb.output");
